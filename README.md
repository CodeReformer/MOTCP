...
<p>To assess the optimality of NSGA-2, which pertains to the quality of its generated solutions, a comparison was made with an optimal solution outlined in Table 3. The generation of optimal solutions involved creating permutations for eight test cases, resulting in 40,320 permutations. Fitness values were then evaluated for each permutation, forming Pareto Fronts. By sorting fitness values for each objective function from the first front, the optimal solution from the 40,320 potential solutions was identified. </p>
...
<p>The optimal solutions generated by the MOTCP model were then compared with these results. Notably, during the TCP analysis in Project P, NSGA-2 effectively achieved the optimal solution, present in the initial set of Pareto Fronts (Table 4). This suggests that if an algorithm can deliver an optimal solution for small-scale projects like P, a hypothesis emerges that it is likely to provide the best solution for larger projects as well.</p>
